## 👋 E aí! Sou o Felipe Rocha

💡 Desenvolvedor backend focado em Ruby on Rails, apaixonado por código limpo, APIs e boas práticas.

🎓 Formado em Ciência da Computação (2024).  
🚀 Crio projetos com Ruby on Rails, RSpec, PostgreSQL, Swagger e JWT.  
📚 Também exploro Java, C#/.NET, Kotlin, React e Hotwire.  
🎮 Fã de simuladores de direção — foco e adaptação na prática.
...
🔹 [ Back-End - Only API (Warranty Manager)](https://github.com/Rochafelip/warranty-manager-backend)  
